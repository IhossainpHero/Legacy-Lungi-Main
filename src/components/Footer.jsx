      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-3 mt-4">
            <Link
              href="https://www.facebook.com/profile.php?id=61571664196304"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 p-2 rounded-full hover:bg-[#ffb400] transition-colors"
            >
              <FaFacebookF size={16} />
            </Link>
            <Link
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm">
            📍 Gopalpur-6740 , Enayetpur , Sirajganj
          </p>
          <p className="text-gray-300 text-sm">📞 +880 1916660952</p>
          <p className="text-gray-300 text-sm">
            📧 imran.hossainp952@gmail.com
          </p>
        </div>
      </div>
